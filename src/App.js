  ...
  return (
    <div className="App">
      ...
      <body className="App-body">
        <h1 className="Body-Title"><FontAwesomeIcon icon={Icons.faGraduationCap} size="1x"/> FORMATIONS</h1>
        <ul>
        ...
        <h1 className="Body-Title"><FontAwesomeIcon icon={Icons.faBriefcase} size="1x"/> EXPÉRIENCES</h1>
        <ul>
          <div className="Body-Entry">
            <div className="Body-Entry-Left">
                <li>
